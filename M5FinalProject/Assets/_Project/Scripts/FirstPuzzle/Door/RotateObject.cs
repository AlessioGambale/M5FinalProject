...
public class RotateObject : MonoBehaviour
{
    ...
    [SerializeField] private bool _canRotateOnTrigger = false;
    ...
    public void StartRotation()
    {
       ...
       Quaternion rotation  = Quaternion.Euler(_rotationAngles);
        _targetRotation = transform.localRotation * rotation;
        _isRotating = true;
        _hasRotated = true;
    }
